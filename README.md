...
Full-Stack Seed project generated on top of **React Berry Dashboard**. The backend logic is provided by a simple, `easy to extend` API Server that manages the Authentication flow (login, registration, logout) using `JSON Web Tokens` (JWT).

<br />

> 🚀 Built with **[React App Generator](https://appseed.us/generator/react/)**, timestamp `2022-06-20 15:20`
